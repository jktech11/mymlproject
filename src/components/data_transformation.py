...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            input_feature_train_df = train_df.drop(target_feature_name,axis=1)
            target_feature_train_df = train_df[target_feature_name]

            input_feature_test_df = test_df.drop(target_feature_name,axis=1)
            ...
            save_object(
                obj = preprocessor_obj, file_path = self.data_transformation_config.preprocessor_obj_file_path
            )
